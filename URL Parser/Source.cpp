...
//bool validDomain(std::string const& str) {
...
int main()
{
    ...
    std::cout << "--------------------------------------------------------------" << std::endl;
    checkURL(urlFtp2);
    //std::cout << std::boolalpha << containsOnlyLetters(urlHttp) << std::endl;
    
    
    // 0 ftp login da go doiztestvam

    // TODO: 1 da sloja proverka za size kato 93 - 94 red zaradi nqkvi stranni situacii v koito size e 0 i ostava pak 0 zaradi povtarqsht se element naprimer
    // 2 da mahna redundant code
    // 3 da go komplektovam v funkciq kudeto moga
    // 4 hex is not full da vidq
